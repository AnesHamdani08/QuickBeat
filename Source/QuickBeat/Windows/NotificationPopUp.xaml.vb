...
Namespace UI.Windows
    Public Class NotificationPopUp
        ...
        Public Shared TextProperty As DependencyProperty = DependencyProperty.Register("Text", GetType(String), GetType(NotificationPopUp))
        ...
        Public Shared TimeoutProperty As DependencyProperty = DependencyProperty.Register("Timeout", GetType(Integer), GetType(NotificationPopUp), New PropertyMetadata(2000))
        ...
        Public Shared ImageProperty As DependencyProperty = DependencyProperty.Register("Image", GetType(ImageSource), GetType(NotificationPopUp))
        ...
        Public Shared FillBackgroundProperty As DependencyProperty = DependencyProperty.Register("FillBackground", GetType(Brush), GetType(NotificationPopUp), New UIPropertyMetadata(New SolidColorBrush(Colors.Transparent)))
        ...
        Public Shared AutoCloseProperty As DependencyProperty = DependencyProperty.Register("AutoClose", GetType(Boolean), GetType(NotificationPopUp), New PropertyMetadata(True))
        ...
        Public Shared DynamicBackgroundProperty As DependencyProperty = DependencyProperty.Register("DynamicBackground", GetType(Boolean), GetType(NotificationPopUp))
        ...
        Public Shared LocationProperty As DependencyProperty = DependencyProperty.Register("Location", GetType(StartupLocation), GetType(NotificationPopUp), New UIPropertyMetadata(StartupLocation.Top))
        ...
        Private Sub NotificationPopUp_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
            If DynamicBackground AndAlso Image IsNot Nothing Then
                Dim Avg = CommonFunctions.GetAverageColor(Image)
        ...
        Public Sub Reveal()
            ...
            Me.MaxWidth = 40
            Dim ft As New FormattedText(Text, Globalization.CultureInfo.CurrentCulture, FlowDirection.LeftToRight, New Typeface(Me.FontFamily, FontStyles.Normal, FontWeights.Regular, FontStretches.Normal), 12, New SolidColorBrush(Color.FromRgb(255, 193, 7)), VisualTreeHelper.GetDpi(Me).PixelsPerDip)
            ...
            Dim sAnim As New Animation.DoubleAnimation(40, ft.Width + 50, New Duration(TimeSpan.FromMilliseconds(500))) With {.BeginTime = TimeSpan.FromMilliseconds(500), .AccelerationRatio = 0.95, .EasingFunction = New Animation.PowerEase() With {.Power = 2, .EasingMode = Animation.EasingMode.EaseInOut}} '30 + 5 +5 +10
        ...
        Private Sub Ellipse_MouseLeftButtonUp(sender As Object, e As MouseButtonEventArgs) Handles Ellipse_Image.MouseLeftButtonUp
